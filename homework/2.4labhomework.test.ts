    ...
    describe("handles unsaved, canceled, and saved changes correctly", () => {
        ...
        */
        ...
        await driver.wait(
            ...
            await driver.findElement(By.name("employee2")),
            "Phillip"
            )
        );
        await driver.findElement(By.name("employee1")).click();
        ...
        test("A canceled change doesn't persist", async () => {
            ...
            */
            ...
            expect(
                await (await driver.findElement(By.name("employee3"))).getAttribute("value")
            ).toBe("Phillip");
        });
        ...
        test("A saved change persists", async () => {
            ...
            */
            ...
            await driver.wait(
                until.elementTextContains(
                await driver.findElement(By.name("nameEntry")),
                "Phillip"
                )
            );
            await driver.findElement(By.name("employee1")).click();
